...
## What I Learned (Summer Project Reflection)
...
This project uses CMake's `FetchContent` to automatically manage dependencies. You do not need to download Raylib manually; CMake will fetch it directly from the master branch during the configuration step.
